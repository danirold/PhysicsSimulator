...
public class Main {
	...
	private final static String _defaultOut = "System.out";
	...
	private static void parseStepsOption(CommandLine line) {
		...
		else _steps = _stepsDefaultValue;
	}
	
	private static void parseOutFileOption(CommandLine line) throws ParseException {
		_outFile = line.getOptionValue("o", _defaultOut);
	}
	...
	private static void startBatchMode() throws Exception {
		...
		c.loadData(in);
		if(_outFile == "System.out") c.run(_steps, System.out);
		c.run(_steps, out);
	}
